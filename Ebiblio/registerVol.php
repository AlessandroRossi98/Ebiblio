...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(!isset($_POST["mezzo"])){
        $mezzo_err = "Inserisci il tuo mezzo di transporto .";
    } else{
    ...
    if(empty($email_err) && empty($password_err) && empty($cognome_err) && empty($nome_err) && empty($luogonascita_err) && empty($datanascita_err)&& empty($recapitotelefonico_err)&& empty($mezzo_err)   ){
      $sql = "call registrazioneVolontario( ?, ? , ? , ? , ? , ? , ?, ?) ";

      echo "sono passato per di qua ";
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            $param_mezzo = $mezzo;
            mysqli_stmt_bind_param($stmt, "ssssssis", $param_email, $param_pass, $param_cognome, $param_nome, $param_luogoN, $param_dataN, $param_telef, $param_mezzo);
            ...
            <div class="form-group <?php echo (!empty($cognome_err)) ? 'has-error' : ''; ?>">
                ...
                <span class="help-block"><?php echo $cognome_err; ?></span>
                        ...
                        <div class="form-group">
                            <label>Mezzo di transporto: </label> <br>
                              Piedi
                              <input type="radio" name="mezzo"
                              <?php if (isset($mezzo) && $mezzo=="Piedi") echo "checked";?>
                              value="Piedi">
                              Bici
                              <input type="radio" name="mezzo"
                              <?php if (isset($mezzo) && $mezzo=="Bici") echo "checked";?>
                              value="Bici">
                              Auto
                              <input type="radio" name="mezzo"
                              <?php if (isset($mezzo) && $mezzo=="Auto") echo "checked";?>
                              value="Auto">
                              <?php if ( !empty($mezzo_err)){
                                ?>
                                <br>

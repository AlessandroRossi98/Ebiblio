...
<!---------------------------------------------------------------------------------------------------------------------------------->
<!--STORED 1 = Visualizzare la classifica dei volontari che hanno effettuato più consegne-->
<!--ClassificaVolontari-->
<div class="row">
<form action = "Sta.php" method = "post">
  ...
  <br>
    ...
    <h3>Volontario con più consegne di sempre</h3>
...
<!---------------------------------------------------------------------------------------------------------------------------------->
<!--STORED 5 = Visualizza classifica dei volontari che hanno fatto maggiori consegne nell'ultimo mese-->
<!--VolontarioDelMese-->
<div class="row">
<form action = "Sta.php" method = "post">
        <h3>Volontario del mese</h3>
...
<!---------------------------------------------------------------------------------------------------------------------------------->
<!--STORED 2 = Visualizzare classifica dei libri cartacei più prenotati-->
<!--ClassificaCartacei-->
<div class="row">
<form action = "Sta.php" method = "post">
        <h3>Libri più letti di sempre</h3>
...
<!---------------------------------------------------------------------------------------------------------------------------------->
<!--STORED 6 = Visualizzare classifica dei libri cartacei maggiormente prenotati nell'ultimo mese-->
<!--LibroDelMese-->
<div class="row">
<form action = "Sta.php" method = "post">
        <h3>Libri più letti del mese</h3>
...
<!---------------------------------------------------------------------------------------------------------------------------------->
<!--STORED 3 = Visualizzare la classifica degli e-book più acceduti-->
<!--ClassificaEbook-->
<div class="row">
<form action = "Sta.php" method = "post">
        <h3>Ebook più letti di sempre</h3>
...
<!---------------------------------------------------------------------------------------------------------------------------------->
<!--STORED 4 = Biblioteche meno utilizzate-->
<!--BibliotecheMenoUtilizzate-->
<div class="row">
<form action = "Sta.php" method = "post">
        <h3>Classifica delle biblioteche più frequentate</h3>
